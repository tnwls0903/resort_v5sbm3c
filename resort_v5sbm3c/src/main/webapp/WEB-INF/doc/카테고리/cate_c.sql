...
SELECT TO_DATE(sysdate, 'YYYY-MM-DD HH24:MI:SS') as rdate FROM dual; -- X
SELECT TO_DATE('2024-05-22 04:50:28', 'YYYY-MM-DD HH24:MI:SS') as rdate FROM dual; -- X
SELECT TO_TIMESTAMP(sysdate, 'YYYY-MM-DD HH24:MI:SS') as rdate FROM dual; -- X
SELECT TO_TIMESTAMP('2024-05-22 04:50:28', 'yyyy-mm-dd hh24:mi:ss') as rdate FROM dual; -- X
SELECT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS') as rdate FROM dual;  -- O
...
-- READ: 목록 ★
SELECT cateno, name, namesub, cnt, TO_CHAR(rdate, 'YYYY-MM-DD HH24:MI:SS') as rdate , seqno, visible
FROM cate
ORDER BY cateno ASC;
