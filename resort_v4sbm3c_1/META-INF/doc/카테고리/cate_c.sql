...
INSERT INTO cate(cateno, name, namesub, cnt, rdate, seqno, visible)
VALUES(CATE_SEQ.nextval, '오버렌딩', '-', 0, sysdate, 2, 'Y');

INSERT INTO cate(cateno, name, namesub, cnt, rdate, seqno, visible)
VALUES(CATE_SEQ.nextval, '개발', 'JAVA', 0, sysdate, 31, 'Y');

INSERT INTO cate(cateno, name, namesub, cnt, rdate, seqno, visible)
VALUES(CATE_SEQ.nextval, '개발', 'Python', 0, sysdate, 32, 'Y');

INSERT INTO cate(cateno, name, namesub, cnt, rdate, seqno, visible)
VALUES(CATE_SEQ.nextval, '오버렌딩', '홍천군', 0, sysdate, 61, 'Y');

INSERT INTO cate(cateno, name, namesub, cnt, rdate, seqno, visible)
VALUES(CATE_SEQ.nextval, '오버렌딩', '평창군', 0, sysdate, 62, 'Y');
