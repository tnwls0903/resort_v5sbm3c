...
VALUES (member_seq.nextval, 'admin', '1234', '통합 관리자', '010-1111-1111', '12345',
             '서울시 종로구', '관철동', sysdate, 1);
             
INSERT INTO member(memberno, id, passwd, mname, tel, zipcode,
                                address1, address2, mdate, grade)
VALUES (member_seq.nextval, 'qnaadmin', '1234', '질문답변관리자', '010-2222-2222', '12345',
             '서울시 종로구', '관철동', sysdate, 1);
 
-- 개인 회원 테스트 계정
INSERT INTO member(memberno, id, passwd, mname, tel, zipcode, address1, address2, mdate, grade)
VALUES (member_seq.nextval, 'user1@gmail.com', '1234', '왕눈이', '000-0000-0000', '54321', '남양주시 진접읍', '부평리', sysdate, 15);
 
INSERT INTO member(memberno, id, passwd, mname, tel, zipcode, address1, address2, mdate, grade)
VALUES (member_seq.nextval, 'user2@gmail.com', '1234', '아로미', '000-0000-0000', '54321', '서울시 중랑구', '중화1동', sysdate, 15);
 
INSERT INTO member(memberno, id, passwd, mname, tel, zipcode, address1, address2, mdate, grade)
VALUES (member_seq.nextval, 'user3@gmail.com', '1234', '투투투', '000-0000-0000', '54321', '서울시 중랑구', '중화2동', sysdate, 15);
 
-- 부서별(그룹별) 공유 회원 기준
INSERT INTO member(memberno, id, passwd, mname, tel, zipcode, address1, address2, mdate, grade)
VALUES (member_seq.nextval, 'team1', '1234', '개발팀', '010-3333-3333', '12345', '서울시 종로구', '관철동', sysdate, 2);
 
INSERT INTO member(memberno, id, passwd, mname, tel, zipcode, address1, address2, mdate, grade)
VALUES (member_seq.nextval, 'team2', '1234', '웹퍼블리셔팀', '010-4444-4444', '12345', '서울시 종로구', '관철동', sysdate, 2);
 
INSERT INTO member(memberno, id, passwd, mname, tel, zipcode, address1, address2, mdate, grade)
VALUES (member_seq.nextval, 'team3', '1234', '디자인팀', '010-5555-5555', '12345', '서울시 종로구', '관철동', sysdate, 2);
